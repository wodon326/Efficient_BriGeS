...
class InSDA(nn.Module):
    ...
    def forward(self, x, y):
        ...
        for neck in self.neck:
            ...
            seg_feat = neck(seg_feat)
            reshaped_seg_feat = seg_feat.reshape(depth_features[0].shape[0], depth_features[0].shape[2], patch_h * patch_w).permute(0, 2, 1)
