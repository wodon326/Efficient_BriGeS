...
class Efficient_BriGeS_naive_only_high_res(nn.Module):
    def __init__(
        self, 
        ImageEncoderViT, 
        encoder='vitb', 
        ...
        super(Efficient_BriGeS_naive_only_high_res, self).__init__()
        print('Efficient_BriGeS_naive_only_high_res')
    ...
    def forward(self, x, y):
        ...
        for idx,(Cross_Attention_Blocks, Blocks, MLP_neck_layers, MLP_final_layers, reshaped_seg_feature) in enumerate(zip(self.Cross_Attention_blocks_layers, self.Blocks_layers, 
                                                                                      self.MLP_neck_layers, self.MLP_final_layers,
                                                                                      reshaped_seg_features)):
            feature = MLP_neck_layers(depth_features[idx])
        ...
        Cross_Attention_Features.append(depth_features[2])
        Cross_Attention_Features.append(depth_features[3])
