...
class Efficient_BriGeS_residual_refine(nn.Module):
    def __init__(
        self, 
        ImageEncoderViT, 
        encoder='vitb', 
        ...
        super(Efficient_BriGeS_residual_refine, self).__init__()
        print('Efficient_BriGeS_residual_refine')
        ...
        self.MLP_refine_layers = nn.ModuleList([
            Mlp(
                in_features = out_channels[3],
                out_features= out_channels[3],
            ) for _ in range(4)])
    ...
    def forward(self, x, y):
        ...
        for Cross_Attention_Blocks, Blocks, MLP_neck_layers, MLP_final_layers, MLP_refine_layers, depth_feature, reshaped_seg_feature in zip(self.Cross_Attention_blocks_layers, self.Blocks_layers, 
                                                                                      self.MLP_neck_layers, self.MLP_final_layers, self.MLP_refine_layers,
            ...
            feature = MLP_refine_layers(feature)
