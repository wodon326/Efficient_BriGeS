...
#     --checkpoint_dir /home/wodon326/project/Efficient_BriGeS/checkpoint_Efficient_BriGeS_residual

# CUDA_VISIBLE_DEVICES=0 python AsymKD_evaluate_ddp_cache_ver.py \
#     --model Efficient_BriGeS_residual \
#     --base_data_dir ~/data/AsymKD \
...
# CUDA_VISIBLE_DEVICES=1 python AsymKD_evaluate_ddp_cache_ver.py \
#     --model Efficient_BriGeS_residual \
#     --base_data_dir ~/data/AsymKD \
...
# CUDA_VISIBLE_DEVICES=2 python AsymKD_evaluate_ddp_cache_ver.py \
#     --model Efficient_BriGeS_residual \
#     --base_data_dir ~/data/AsymKD \
